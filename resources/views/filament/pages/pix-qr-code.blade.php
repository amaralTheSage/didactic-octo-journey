<x-filament::page>
    <div x-data="paymentListener({{ $payment }})" class=" max-w-5xl mx-auto fi-card" >
        ...
        <div x-show="paid" x-cloak class="bg-white rounded-lg shadow p-6 text-center">
            ...
            <a href="{{ route('filament.admin.resources.campaign-announcements.index') }}" class=" flex items-center gap-1 mt-6 justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-left-icon lucide-chevron-left  h-full"><path d="m15 18-6-6 6-6"/></svg>
