...
export default function StatsAccordion({
    ...
    if (variant === 1) {
        ...
        return (
            <section className="relative overflow-hidden bg-slate-100 px-4 py-24 text-slate-900 md:px-8 lg:px-16">
                {/* Subtle background glow */}
                <div className="pointer-events-none absolute top-0 left-0 h-full w-full bg-gradient-to-tr from-blue-500/50 to-transparent"></div>
                ...
                <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
                    ...
                    <div className="flex flex-col">
                        {items.map((item, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`transition-all duration-500 ease-in-out ${isOpen ? 'py-8' : 'group cursor-pointer py-6'}`}
                                    onClick={() => setOpenIndex(index)}
                                >
                                    <div className="mb-4 flex items-center justify-between">
                                        <div className="flex items-baseline gap-6">
                    ...
                    <div className="flex flex-col items-end justify-center text-right">
                        ...
                        <h2 className="mb-8 text-right text-6xl leading-[0.9] font-medium tracking-tighter text-slate-950 md:text-7xl lg:text-8xl">
                            {headlineParts[0]}
                            <br />
                            <span className="flex items-center gap-4 text-cyan-700">
                                <Loader2
