const Ziggy = {
    ...
    routes: {
        'socialite.filament.admin.oauth.redirect': {
            uri: 'dashboard\/oauth\/{provider}',
            methods: ['GET', 'HEAD'],
            parameters: ['provider'],
        },
        'socialite.filament.admin.oauth.callback': {
            uri: 'dashboard\/oauth\/callback\/{provider}',
        ...
        'filament.admin.resources.influencer-campaigns.index': {
            uri: 'dashboard\/influencer-campaigns',
            methods: ['GET', 'HEAD'],
        },
        'filament.admin.resources.influencers.index': {
            uri: 'dashboard\/influencers',
            methods: ['GET', 'HEAD'],
        },
        'filament.admin.resources.influencers.edit': {
            uri: 'dashboard\/influencers\/{record}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['record'],
        },
        ...
        'filament.admin.resources.products.edit': {
            uri: 'dashboard\/products\/{record}\/edit',
            methods: ['GET', 'HEAD'],
            parameters: ['record'],
        },
        ...
        'chats.store': { uri: 'chats', methods: ['POST'] },
        'chats.show': {
            uri: 'chats\/{chat}',
            methods: ['GET', 'HEAD'],
            parameters: ['chat'],
        ...
        'chats.delete-image': {
            uri: 'chats\/{chat}\/image',
            methods: ['DELETE'],
            parameters: ['chat'],
            bindings: { chat: 'id' },
        },
        'messages.store': {
            uri: 'chats\/{chat}\/messages',
            methods: ['POST'],
            parameters: ['chat'],
            bindings: { chat: 'id' },
        },
